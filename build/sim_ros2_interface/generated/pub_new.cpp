    ...
    {
        rclcpp::QoS qos = 10;
        publisherProxy->publisher = node->create_publisher<geometry_msgs::msg::Twist>(in->topicName, qos);
    }
    ...
    {
        rclcpp::QoS qos = 10;
        publisherProxy->publisher = node->create_publisher<std_msgs::msg::Float32MultiArray>(in->topicName, qos);
    }
    ...
    {
        rclcpp::QoS qos = 10;
        publisherProxy->publisher = node->create_publisher<std_msgs::msg::MultiArrayDimension>(in->topicName, qos);
    }
    else if(in->topicType == "std_msgs/msg/MultiArrayLayout")
    {
        rclcpp::QoS qos = 10;
        publisherProxy->publisher = node->create_publisher<std_msgs::msg::MultiArrayLayout>(in->topicName, qos);
    }
