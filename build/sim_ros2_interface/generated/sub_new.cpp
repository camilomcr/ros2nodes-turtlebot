    ...
    else if(in->topicType == "geometry_msgs/msg/Twist")
    {
        ...
        rclcpp::QoS qos = 10;
        subscriptionProxy->subscription = node->create_subscription<geometry_msgs::msg::Twist>(in->topicName, qos, cb);
    }
    ...
    else if(in->topicType == "std_msgs/msg/Float32MultiArray")
    {
        auto cb = [=](const std_msgs::msg::Float32MultiArray::SharedPtr msg) { ros_callback__std_msgs__msg__Float32MultiArray(msg, subscriptionProxy); };
        rclcpp::QoS qos = 10;
        subscriptionProxy->subscription = node->create_subscription<std_msgs::msg::Float32MultiArray>(in->topicName, qos, cb);
    }
    ...
    else if(in->topicType == "std_msgs/msg/MultiArrayDimension")
    {
        auto cb = [=](const std_msgs::msg::MultiArrayDimension::SharedPtr msg) { ros_callback__std_msgs__msg__MultiArrayDimension(msg, subscriptionProxy); };
        rclcpp::QoS qos = 10;
        subscriptionProxy->subscription = node->create_subscription<std_msgs::msg::MultiArrayDimension>(in->topicName, qos, cb);
    }
    else if(in->topicType == "std_msgs/msg/MultiArrayLayout")
    {
        auto cb = [=](const std_msgs::msg::MultiArrayLayout::SharedPtr msg) { ros_callback__std_msgs__msg__MultiArrayLayout(msg, subscriptionProxy); };
        rclcpp::QoS qos = 10;
        subscriptionProxy->subscription = node->create_subscription<std_msgs::msg::MultiArrayLayout>(in->topicName, qos, cb);
    }
