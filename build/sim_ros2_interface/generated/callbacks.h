...
void write__std_msgs__msg__Float32MultiArray(const std_msgs::msg::Float32MultiArray& msg, int stack, const ROS2WriteOptions *opt = NULL);
void read__std_msgs__msg__Float32MultiArray(int stack, std_msgs::msg::Float32MultiArray *msg, const ROS2ReadOptions *opt = NULL);
...
void write__std_msgs__msg__MultiArrayDimension(const std_msgs::msg::MultiArrayDimension& msg, int stack, const ROS2WriteOptions *opt = NULL);
void read__std_msgs__msg__MultiArrayDimension(int stack, std_msgs::msg::MultiArrayDimension *msg, const ROS2ReadOptions *opt = NULL);
void write__std_msgs__msg__MultiArrayLayout(const std_msgs::msg::MultiArrayLayout& msg, int stack, const ROS2WriteOptions *opt = NULL);
void read__std_msgs__msg__MultiArrayLayout(int stack, std_msgs::msg::MultiArrayLayout *msg, const ROS2ReadOptions *opt = NULL);
