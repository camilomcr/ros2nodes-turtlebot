    ...
    else if(publisherProxy->topicType == "std_msgs/msg/Float32MultiArray")
    {
        auto pub = boost::any_cast< std::shared_ptr< rclcpp::Publisher<std_msgs::msg::Float32MultiArray> > >(publisherProxy->publisher);
        std_msgs::msg::Float32MultiArray msg;
        read__std_msgs__msg__Float32MultiArray(in->_.stackID, &msg, &(publisherProxy->rd_opt));
        pub->publish(msg);
    }
    ...
    else if(publisherProxy->topicType == "std_msgs/msg/MultiArrayDimension")
    {
        auto pub = boost::any_cast< std::shared_ptr< rclcpp::Publisher<std_msgs::msg::MultiArrayDimension> > >(publisherProxy->publisher);
        std_msgs::msg::MultiArrayDimension msg;
        read__std_msgs__msg__MultiArrayDimension(in->_.stackID, &msg, &(publisherProxy->rd_opt));
        pub->publish(msg);
    }
    else if(publisherProxy->topicType == "std_msgs/msg/MultiArrayLayout")
    {
        auto pub = boost::any_cast< std::shared_ptr< rclcpp::Publisher<std_msgs::msg::MultiArrayLayout> > >(publisherProxy->publisher);
        std_msgs::msg::MultiArrayLayout msg;
        read__std_msgs__msg__MultiArrayLayout(in->_.stackID, &msg, &(publisherProxy->rd_opt));
        pub->publish(msg);
    }
