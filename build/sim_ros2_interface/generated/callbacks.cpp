...
void write__std_msgs__msg__Float32MultiArray(const std_msgs::msg::Float32MultiArray& msg, int stack, const ROS2WriteOptions *opt)
{
    try
    {
        sim::pushTableOntoStack(stack);
        ...
        {
            // write field 'layout'
            sim::pushStringOntoStack(stack, "layout", 0);
            write__std_msgs__msg__MultiArrayLayout(msg.layout, stack, opt);
            sim::insertDataIntoStackTable(stack);
        }
        catch(std::exception &ex)
        {
        ...
        try
        {
            // write field 'data' (using fast specialized function)
            sim::pushStringOntoStack(stack, "data", 0);
            sim::pushFloatTableOntoStack(stack, &(msg.data[0]), msg.data.size());
            sim::insertDataIntoStackTable(stack);
        }
        catch(std::exception &ex)
        {
    ...
    {
        std::string msg = "write__std_msgs__msg__Float32MultiArray: ";
        msg += ex.what();
        throw sim::exception(msg);
    }
}

void read__std_msgs__msg__Float32MultiArray(int stack, std_msgs::msg::Float32MultiArray *msg, const ROS2ReadOptions *opt)
{
    try
    {
        int r = sim::getStackTableInfo(stack, 0);
        ...
        while(numItems >= 1)
        {
            ...
            if((str = sim::getStackStringValue(stack, &strSz)) != NULL && strSz > 0)
            {
                ...
                else if(strcmp(str, "layout") == 0)
                {
                    ...
                    {
                        // read field 'layout'
                        read__std_msgs__msg__MultiArrayLayout(stack, &(msg->layout), opt);
                    }
                    catch(std::exception &ex)
                    {
                        std::string msg = "field layout: ";
                ...
                else if(strcmp(str, "data") == 0)
                {
                    try
                    {
                        ...
                        if(sim::getStackTableInfo(stack, 2) != 1)
                            throw sim::exception("fast_write_type reader exception #1");
                        msg->data.resize(sz);
                        sim::getStackFloatTable(stack, &(msg->data[0]), sz);
                        sim::popStackItem(stack, 1);
                    }
                    catch(std::exception &ex)
                    {
    ...
    {
        std::string msg = "read__std_msgs__msg__Float32MultiArray: ";
        msg += ex.what();
        throw sim::exception(msg);
    }
}
...
void write__std_msgs__msg__MultiArrayDimension(const std_msgs::msg::MultiArrayDimension& msg, int stack, const ROS2WriteOptions *opt)
{
    try
    {
        sim::pushTableOntoStack(stack);
        ...
        {
            // write field 'label'
            sim::pushStringOntoStack(stack, "label", 0);
        ...
        {
            // write field 'size'
            sim::pushStringOntoStack(stack, "size", 0);
        ...
        {
            // write field 'stride'
            sim::pushStringOntoStack(stack, "stride", 0);
    ...
    {
        std::string msg = "write__std_msgs__msg__MultiArrayDimension: ";
        msg += ex.what();
        throw sim::exception(msg);
    }
}

void read__std_msgs__msg__MultiArrayDimension(int stack, std_msgs::msg::MultiArrayDimension *msg, const ROS2ReadOptions *opt)
{
    try
    {
        int r = sim::getStackTableInfo(stack, 0);
    ...
    {
        std::string msg = "read__std_msgs__msg__MultiArrayDimension: ";
        msg += ex.what();
        throw sim::exception(msg);
    }
}

void write__std_msgs__msg__MultiArrayLayout(const std_msgs::msg::MultiArrayLayout& msg, int stack, const ROS2WriteOptions *opt)
{
    try
    {
        sim::pushTableOntoStack(stack);
        ...
        {
            // write field 'dim'
            sim::pushStringOntoStack(stack, "dim", 0);
            sim::pushTableOntoStack(stack);
            for(int i = 0; i < msg.dim.size(); i++)
            {
                write__int32(i + 1, stack, opt);
                write__std_msgs__msg__MultiArrayDimension(msg.dim[i], stack, opt);
                sim::insertDataIntoStackTable(stack);
            }
            sim::insertDataIntoStackTable(stack);
        }
        ...
        try
        {
            ...
            sim::pushStringOntoStack(stack, "data_offset", 0);
    ...
    {
        std::string msg = "write__std_msgs__msg__MultiArrayLayout: ";
        msg += ex.what();
        throw sim::exception(msg);
    }
}

void read__std_msgs__msg__MultiArrayLayout(int stack, std_msgs::msg::MultiArrayLayout *msg, const ROS2ReadOptions *opt)
{
    try
    {
        int r = sim::getStackTableInfo(stack, 0);
                ...
                else if(strcmp(str, "dim") == 0)
                {
                    try
                    {
                        ...
                        for(int i = 0; i < numItems1; i++)
                        {
                            ...
                            read__int32(stack, &j, opt);
                            sim::moveStackItemToTop(stack, oldsz1 - 1); // move value to top
                            std_msgs::msg::MultiArrayDimension v;
                            read__std_msgs__msg__MultiArrayDimension(stack, &v, opt);
                            msg->dim.push_back(v);
                        }
                    }
                    catch(std::exception &ex)
    ...
    {
        std::string msg = "read__std_msgs__msg__MultiArrayLayout: ";
        msg += ex.what();
        throw sim::exception(msg);
    }
}
...
void ros_callback__std_msgs__msg__Float32MultiArray(const std_msgs::msg::Float32MultiArray::SharedPtr msg, SubscriptionProxy *proxy)
{
    int stack = -1;
    try
    {
        stack = sim::createStack();
        write__std_msgs__msg__Float32MultiArray(*msg, stack, &(proxy->wr_opt));
        sim::callScriptFunctionEx(proxy->topicCallback.scriptId, proxy->topicCallback.name.c_str(), stack);
        sim::releaseStack(stack);
        stack = -1;
    }
    catch(std::exception &ex)
    {
        if(stack != -1)
            simReleaseStack(stack); // don't throw
        std::string msg = "ros_callback__std_msgs__msg__Float32MultiArray: ";
        msg += ex.what();
        simSetLastError(proxy->topicCallback.name.c_str(), msg.c_str());
    }
}
...
void ros_callback__std_msgs__msg__MultiArrayDimension(const std_msgs::msg::MultiArrayDimension::SharedPtr msg, SubscriptionProxy *proxy)
{
    int stack = -1;
    try
    {
        stack = sim::createStack();
        write__std_msgs__msg__MultiArrayDimension(*msg, stack, &(proxy->wr_opt));
        sim::callScriptFunctionEx(proxy->topicCallback.scriptId, proxy->topicCallback.name.c_str(), stack);
        sim::releaseStack(stack);
        stack = -1;
    }
    catch(std::exception &ex)
    {
        if(stack != -1)
            simReleaseStack(stack); // don't throw
        std::string msg = "ros_callback__std_msgs__msg__MultiArrayDimension: ";
        msg += ex.what();
        simSetLastError(proxy->topicCallback.name.c_str(), msg.c_str());
    }
}

void ros_callback__std_msgs__msg__MultiArrayLayout(const std_msgs::msg::MultiArrayLayout::SharedPtr msg, SubscriptionProxy *proxy)
{
    int stack = -1;
    try
    {
        stack = sim::createStack();
        write__std_msgs__msg__MultiArrayLayout(*msg, stack, &(proxy->wr_opt));
        sim::callScriptFunctionEx(proxy->topicCallback.scriptId, proxy->topicCallback.name.c_str(), stack);
        sim::releaseStack(stack);
        stack = -1;
    }
    catch(std::exception &ex)
    {
        if(stack != -1)
            simReleaseStack(stack); // don't throw
        std::string msg = "ros_callback__std_msgs__msg__MultiArrayLayout: ";
        msg += ex.what();
        simSetLastError(proxy->topicCallback.name.c_str(), msg.c_str());
    }
}
